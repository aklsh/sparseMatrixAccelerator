...
`define AUTOTB_TVIN_subrow_vals_0  "./c.accelerate.autotvin_subrow_vals_0.dat"
`define AUTOTB_TVIN_subrow_vals_1  "./c.accelerate.autotvin_subrow_vals_1.dat"
`define AUTOTB_TVIN_subrow_vals_2  "./c.accelerate.autotvin_subrow_vals_2.dat"
`define AUTOTB_TVIN_subrow_vals_3  "./c.accelerate.autotvin_subrow_vals_3.dat"
`define AUTOTB_TVIN_subrow_col_indices_0  "./c.accelerate.autotvin_subrow_col_indices_0.dat"
`define AUTOTB_TVIN_subrow_col_indices_1  "./c.accelerate.autotvin_subrow_col_indices_1.dat"
`define AUTOTB_TVIN_subrow_col_indices_2  "./c.accelerate.autotvin_subrow_col_indices_2.dat"
`define AUTOTB_TVIN_subrow_col_indices_3  "./c.accelerate.autotvin_subrow_col_indices_3.dat"
`define AUTOTB_TVIN_mult_enables_0  "./c.accelerate.autotvin_mult_enables_0.dat"
`define AUTOTB_TVIN_mult_enables_1  "./c.accelerate.autotvin_mult_enables_1.dat"
`define AUTOTB_TVIN_mult_enables_2  "./c.accelerate.autotvin_mult_enables_2.dat"
`define AUTOTB_TVIN_mult_enables_3  "./c.accelerate.autotvin_mult_enables_3.dat"
`define AUTOTB_TVIN_label_r  "./c.accelerate.autotvin_label_r.dat"
`define AUTOTB_TVIN_init_vector_0  "./c.accelerate.autotvin_init_vector_0.dat"
`define AUTOTB_TVIN_init_vector_1  "./c.accelerate.autotvin_init_vector_1.dat"
`define AUTOTB_TVIN_init_vector_2  "./c.accelerate.autotvin_init_vector_2.dat"
`define AUTOTB_TVIN_init_vector_3  "./c.accelerate.autotvin_init_vector_3.dat"
`define AUTOTB_TVIN_init_vector_4  "./c.accelerate.autotvin_init_vector_4.dat"
`define AUTOTB_TVIN_init_vector_5  "./c.accelerate.autotvin_init_vector_5.dat"
`define AUTOTB_TVIN_init_vector_6  "./c.accelerate.autotvin_init_vector_6.dat"
`define AUTOTB_TVIN_init_vector_7  "./c.accelerate.autotvin_init_vector_7.dat"
`define AUTOTB_TVIN_init_vector_8  "./c.accelerate.autotvin_init_vector_8.dat"
`define AUTOTB_TVIN_init_vector_9  "./c.accelerate.autotvin_init_vector_9.dat"
`define AUTOTB_TVIN_init_vector_10  "./c.accelerate.autotvin_init_vector_10.dat"
`define AUTOTB_TVIN_init_vector_11  "./c.accelerate.autotvin_init_vector_11.dat"
`define AUTOTB_TVIN_init_vector_12  "./c.accelerate.autotvin_init_vector_12.dat"
`define AUTOTB_TVIN_init_vector_13  "./c.accelerate.autotvin_init_vector_13.dat"
`define AUTOTB_TVIN_init_vector_14  "./c.accelerate.autotvin_init_vector_14.dat"
`define AUTOTB_TVIN_init_vector_15  "./c.accelerate.autotvin_init_vector_15.dat"
`define AUTOTB_TVIN_init_vector_16  "./c.accelerate.autotvin_init_vector_16.dat"
`define AUTOTB_TVIN_init_vector_17  "./c.accelerate.autotvin_init_vector_17.dat"
`define AUTOTB_TVIN_init_vector_18  "./c.accelerate.autotvin_init_vector_18.dat"
`define AUTOTB_TVIN_init_vector_19  "./c.accelerate.autotvin_init_vector_19.dat"
`define AUTOTB_TVIN_init_vector_20  "./c.accelerate.autotvin_init_vector_20.dat"
`define AUTOTB_TVIN_init_vector_21  "./c.accelerate.autotvin_init_vector_21.dat"
`define AUTOTB_TVIN_init_vector_22  "./c.accelerate.autotvin_init_vector_22.dat"
`define AUTOTB_TVIN_init  "./c.accelerate.autotvin_init.dat"
`define AUTOTB_TVIN_subrow_vals_0_out_wrapc  "./rtl.accelerate.autotvin_subrow_vals_0.dat"
`define AUTOTB_TVIN_subrow_vals_1_out_wrapc  "./rtl.accelerate.autotvin_subrow_vals_1.dat"
`define AUTOTB_TVIN_subrow_vals_2_out_wrapc  "./rtl.accelerate.autotvin_subrow_vals_2.dat"
`define AUTOTB_TVIN_subrow_vals_3_out_wrapc  "./rtl.accelerate.autotvin_subrow_vals_3.dat"
`define AUTOTB_TVIN_subrow_col_indices_0_out_wrapc  "./rtl.accelerate.autotvin_subrow_col_indices_0.dat"
`define AUTOTB_TVIN_subrow_col_indices_1_out_wrapc  "./rtl.accelerate.autotvin_subrow_col_indices_1.dat"
`define AUTOTB_TVIN_subrow_col_indices_2_out_wrapc  "./rtl.accelerate.autotvin_subrow_col_indices_2.dat"
`define AUTOTB_TVIN_subrow_col_indices_3_out_wrapc  "./rtl.accelerate.autotvin_subrow_col_indices_3.dat"
`define AUTOTB_TVIN_mult_enables_0_out_wrapc  "./rtl.accelerate.autotvin_mult_enables_0.dat"
`define AUTOTB_TVIN_mult_enables_1_out_wrapc  "./rtl.accelerate.autotvin_mult_enables_1.dat"
`define AUTOTB_TVIN_mult_enables_2_out_wrapc  "./rtl.accelerate.autotvin_mult_enables_2.dat"
`define AUTOTB_TVIN_mult_enables_3_out_wrapc  "./rtl.accelerate.autotvin_mult_enables_3.dat"
`define AUTOTB_TVIN_label_r_out_wrapc  "./rtl.accelerate.autotvin_label_r.dat"
`define AUTOTB_TVIN_init_vector_0_out_wrapc  "./rtl.accelerate.autotvin_init_vector_0.dat"
`define AUTOTB_TVIN_init_vector_1_out_wrapc  "./rtl.accelerate.autotvin_init_vector_1.dat"
`define AUTOTB_TVIN_init_vector_2_out_wrapc  "./rtl.accelerate.autotvin_init_vector_2.dat"
`define AUTOTB_TVIN_init_vector_3_out_wrapc  "./rtl.accelerate.autotvin_init_vector_3.dat"
`define AUTOTB_TVIN_init_vector_4_out_wrapc  "./rtl.accelerate.autotvin_init_vector_4.dat"
`define AUTOTB_TVIN_init_vector_5_out_wrapc  "./rtl.accelerate.autotvin_init_vector_5.dat"
`define AUTOTB_TVIN_init_vector_6_out_wrapc  "./rtl.accelerate.autotvin_init_vector_6.dat"
`define AUTOTB_TVIN_init_vector_7_out_wrapc  "./rtl.accelerate.autotvin_init_vector_7.dat"
`define AUTOTB_TVIN_init_vector_8_out_wrapc  "./rtl.accelerate.autotvin_init_vector_8.dat"
`define AUTOTB_TVIN_init_vector_9_out_wrapc  "./rtl.accelerate.autotvin_init_vector_9.dat"
`define AUTOTB_TVIN_init_vector_10_out_wrapc  "./rtl.accelerate.autotvin_init_vector_10.dat"
`define AUTOTB_TVIN_init_vector_11_out_wrapc  "./rtl.accelerate.autotvin_init_vector_11.dat"
`define AUTOTB_TVIN_init_vector_12_out_wrapc  "./rtl.accelerate.autotvin_init_vector_12.dat"
`define AUTOTB_TVIN_init_vector_13_out_wrapc  "./rtl.accelerate.autotvin_init_vector_13.dat"
`define AUTOTB_TVIN_init_vector_14_out_wrapc  "./rtl.accelerate.autotvin_init_vector_14.dat"
`define AUTOTB_TVIN_init_vector_15_out_wrapc  "./rtl.accelerate.autotvin_init_vector_15.dat"
`define AUTOTB_TVIN_init_vector_16_out_wrapc  "./rtl.accelerate.autotvin_init_vector_16.dat"
`define AUTOTB_TVIN_init_vector_17_out_wrapc  "./rtl.accelerate.autotvin_init_vector_17.dat"
`define AUTOTB_TVIN_init_vector_18_out_wrapc  "./rtl.accelerate.autotvin_init_vector_18.dat"
`define AUTOTB_TVIN_init_vector_19_out_wrapc  "./rtl.accelerate.autotvin_init_vector_19.dat"
`define AUTOTB_TVIN_init_vector_20_out_wrapc  "./rtl.accelerate.autotvin_init_vector_20.dat"
`define AUTOTB_TVIN_init_vector_21_out_wrapc  "./rtl.accelerate.autotvin_init_vector_21.dat"
`define AUTOTB_TVIN_init_vector_22_out_wrapc  "./rtl.accelerate.autotvin_init_vector_22.dat"
`define AUTOTB_TVIN_init_out_wrapc  "./rtl.accelerate.autotvin_init.dat"
`define AUTOTB_TVOUT_out_r  "./c.accelerate.autotvout_out_r.dat"
`define AUTOTB_TVOUT_out_r_out_wrapc  "./impl_rtl.accelerate.autotvout_out_r.dat"
module `AUTOTB_TOP;
...
initial begin : generate_AESL_ready_cnt_proc
    ...
    fp1 = $fopen("./rtl.accelerate.autotvout_out_r.dat", "r");
    fp2 = $fopen("./impl_rtl.accelerate.autotvout_out_r.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.accelerate.autotvout_out_r.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.accelerate.autotvout_out_r.dat\"!");
    else begin
        $display("Comparing rtl.accelerate.autotvout_out_r.dat with impl_rtl.accelerate.autotvout_out_r.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
