...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "accelerate.autotvin.dat"
	set constFileTvOut       "accelerate.autotvout.dat"
	set constFileHdlTvIn     "accelerate.autohdltvin.dat"
	set constFileHdlTvOut    "accelerate.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
