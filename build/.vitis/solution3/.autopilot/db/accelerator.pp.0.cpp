...
# 37 "SPMV_CSR_src/accelerator/accelerator.cpp"

#pragma HLS PIPELINE

 static int storage[23];
#pragma HLSDIRECTIVE BIND_STORAGE variable=storage type=ram_1wnr impl=bram
# 40 "SPMV_CSR_src/accelerator/accelerator.cpp"
