...
set ArgLastReadFirstWriteLatency {
	accelerate {
		...
		label_r {Type I LastRead 13 FirstWrite -1}
...
set Spec2ImplPortList { 
	...
	init_vector { ap_memory {  { init_vector_address0 mem_address 1 5 }  { init_vector_ce0 mem_ce 1 1 }  { init_vector_q0 in_data 0 32 }  { init_vector_address1 MemPortADDR2 1 5 }  { init_vector_ce1 MemPortCE2 1 1 }  { init_vector_q1 in_data 0 32 } } }
