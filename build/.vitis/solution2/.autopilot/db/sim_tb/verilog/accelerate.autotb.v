...
`define AUTOTB_TVIN_subrow_vals  "./c.accelerate.autotvin_subrow_vals.dat"
`define AUTOTB_TVIN_subrow_col_indices  "./c.accelerate.autotvin_subrow_col_indices.dat"
`define AUTOTB_TVIN_mult_enables  "./c.accelerate.autotvin_mult_enables.dat"
`define AUTOTB_TVIN_label_r  "./c.accelerate.autotvin_label_r.dat"
`define AUTOTB_TVIN_init_vector  "./c.accelerate.autotvin_init_vector.dat"
`define AUTOTB_TVIN_init  "./c.accelerate.autotvin_init.dat"
`define AUTOTB_TVIN_subrow_vals_out_wrapc  "./rtl.accelerate.autotvin_subrow_vals.dat"
`define AUTOTB_TVIN_subrow_col_indices_out_wrapc  "./rtl.accelerate.autotvin_subrow_col_indices.dat"
`define AUTOTB_TVIN_mult_enables_out_wrapc  "./rtl.accelerate.autotvin_mult_enables.dat"
`define AUTOTB_TVIN_label_r_out_wrapc  "./rtl.accelerate.autotvin_label_r.dat"
`define AUTOTB_TVIN_init_vector_out_wrapc  "./rtl.accelerate.autotvin_init_vector.dat"
