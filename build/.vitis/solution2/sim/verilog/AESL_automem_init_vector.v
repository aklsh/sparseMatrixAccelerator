...
module AESL_automem_init_vector (
    clk,
    rst,
    ce0,
    we0,
...
//------------------------Parameter----------------------
localparam
    TV_IN  = "../tv/cdatafile/c.accelerate.autotvin_init_vector.dat", 
    TV_OUT = "../tv/rtldatafile/rtl.accelerate.autotvout_init_vector.dat"; 
//------------------------Local signal-------------------
parameter DATA_WIDTH = 32'd 32;
parameter ADDR_WIDTH = 32'd 5;
parameter DEPTH = 32'd 23;
parameter DLY = 0.1;
