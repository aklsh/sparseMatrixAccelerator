...
if {[file isfile accelerate.autotvin.dat]} {
	file delete -force accelerate.autotvin.dat
}

if {[file isfile accelerate.autotvout.dat]} {
	file delete -force accelerate.autotvout.dat
}
