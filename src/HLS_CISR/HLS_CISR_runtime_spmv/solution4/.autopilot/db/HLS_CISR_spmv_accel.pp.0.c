    ...
    if(cmd_start)
       {
        ...
        VITIS_LOOP_25_1: for(int slot_id=0;slot_id<2;slot_id++)
            {
           ...
           VITIS_LOOP_35_2: for(int i=0;i<4;i++)
           {
...
void store_row_len_arr(int *slot_counter,int *slot_arr_row_len,int row_len_slot_arr[2][4])
{
    ...
    VITIS_LOOP_49_1: for(int slot_id1=0;slot_id1<2;slot_id1++)
    {
...
void CISR_decoder(int *slot_row_counter,int row_len_slot_arr[2][4],float *slot_res_arr,int *slot_row_len_id,int *slot_row_id,int* max_row_id)
{
   ...
   VITIS_LOOP_68_1: for(int slot_id2=0;slot_id2<2;slot_id2++)
            {
# 80 "HLS_CISR_spmv_accel.c"
...
void compute(struct slot_data *slot_data_arr,float *inp_vec,float *slot_res_arr,int *slot_row_counter)
{
  ...
  VITIS_LOOP_102_1: for(int slot_id3=0;slot_id3<2;slot_id3++)
      {
...
{
    VITIS_LOOP_124_1: for(int slot_id4=0;slot_id4<2;slot_id4++)
     {
#pragma HLS unroll factor=2
...
{_ssdm_SpecArrayDimSize(inp_vec, 8);_ssdm_SpecArrayDimSize(slot_data_arr, 2);_ssdm_SpecArrayDimSize(slot_arr_row_len, 2);_ssdm_SpecArrayDimSize(output_vec, 8);
