...
set C_modelArgList {
	...
	{ slot_data_arr int 64 regular {array 4 { 1 3 } 1 1 }  }
	{ slot_arr_row_len int 32 regular {array 4 { 1 3 } 1 1 }  }
...
set portList { 
	...
	{ slot_data_arr_address0 sc_out sc_lv 2 signal 2 } 
	{ slot_data_arr_ce0 sc_out sc_logic 1 signal 2 } 
	{ slot_data_arr_q0 sc_in sc_lv 64 signal 2 } 
	{ slot_arr_row_len_address0 sc_out sc_lv 2 signal 3 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "slot_data_arr_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":2, "type": "signal", "bundle":{"name": "slot_data_arr", "role": "address0" }} , 
 	...
 	{ "name": "slot_arr_row_len_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":2, "type": "signal", "bundle":{"name": "slot_arr_row_len", "role": "address0" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3"],
		...
		"II" : "0",
		"VariableLatency" : "1", "ExactLatency" : "-1", "EstimateLatencyMin" : "24", "EstimateLatencyMax" : "29",
		"Combinational" : "0",
		"Datapath" : "0",
		"ClockEnable" : "0",
		"HasSubDataflow" : "0",
		...
		"Port" : [
			...
			{"Name" : "slot_res_arr_2", "Type" : "OVld", "Direction" : "IO"},
			{"Name" : "slot_row_len_id_2", "Type" : "OVld", "Direction" : "IO"},
			{"Name" : "slot_row_id_2", "Type" : "OVld", "Direction" : "IO"},
			{"Name" : "slot_row_counter_3", "Type" : "OVld", "Direction" : "IO"},
			{"Name" : "slot_res_arr_3", "Type" : "OVld", "Direction" : "IO"},
			{"Name" : "slot_row_len_id_3", "Type" : "OVld", "Direction" : "IO"},
			{"Name" : "slot_row_id_3", "Type" : "OVld", "Direction" : "IO"}]},
...
set ArgLastReadFirstWriteLatency {
	HLS_CISR_spmv_accel {
		...
		inp_vec {Type I LastRead 14 FirstWrite -1}
		slot_data_arr {Type I LastRead 13 FirstWrite -1}
		slot_arr_row_len {Type I LastRead 5 FirstWrite -1}
		output_vec {Type O LastRead -1 FirstWrite 22}
		...
		slot_res_arr_2 {Type IO LastRead -1 FirstWrite -1}
		slot_row_len_id_2 {Type IO LastRead -1 FirstWrite -1}
		slot_row_id_2 {Type IO LastRead -1 FirstWrite -1}
		slot_row_counter_3 {Type IO LastRead -1 FirstWrite -1}
		slot_res_arr_3 {Type IO LastRead -1 FirstWrite -1}
		slot_row_len_id_3 {Type IO LastRead -1 FirstWrite -1}
		slot_row_id_3 {Type IO LastRead -1 FirstWrite -1}}}

set hasDtUnsupportedChannel 0

set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "24", "Max" : "29"}
	, {"Name" : "Interval", "Min" : "25", "Max" : "30"}
]}
...
set Spec2ImplPortList { 
	...
	slot_data_arr { ap_memory {  { slot_data_arr_address0 mem_address 1 2 }  { slot_data_arr_ce0 mem_ce 1 1 }  { slot_data_arr_q0 mem_dout 0 64 } } }
	slot_arr_row_len { ap_memory {  { slot_arr_row_len_address0 mem_address 1 2 }  { slot_arr_row_len_ce0 mem_ce 1 1 }  { slot_arr_row_len_q0 mem_dout 0 32 } } }
