    ...
    string AESL_num;{
      ...
      if (rtl_tv_out_file.good()) {
        ...
        if (atoi(AESL_num.c_str()) == AESL_transaction_pc) {
          std::vector<sc_bv<32> > output_vec_pc_buffer(1);
          int i = 0;
          ...
          if (i > 0) {
            ((int*)__xlx_apatb_param_output_vec)[0] = output_vec_pc_buffer[0].to_int64();
          }
        } // end transaction
      } // end file is good
...
// print inp_vec Transactions
{
  ...
  {
    sc_bv<32> __xlx_tmp_lv = *((int*)__xlx_apatb_param_inp_vec);

    sprintf(__xlx_sprintf_buffer.data(), "%s\n", __xlx_tmp_lv.to_string(SC_HEX).c_str());
    aesl_fh.write(AUTOTB_TVIN_inp_vec, __xlx_sprintf_buffer.data()); 
  }
  tcl_file.set_num(1, &tcl_file.inp_vec_depth);
  sprintf(__xlx_sprintf_buffer.data(), "[[/transaction]] \n");
  aesl_fh.write(AUTOTB_TVIN_inp_vec, __xlx_sprintf_buffer.data());
}
// print slot_data_arr Transactions
{
  ...
  {
    sc_bv<64> __xlx_tmp_lv = *((long long*)__xlx_apatb_param_slot_data_arr);

    sprintf(__xlx_sprintf_buffer.data(), "%s\n", __xlx_tmp_lv.to_string(SC_HEX).c_str());
    aesl_fh.write(AUTOTB_TVIN_slot_data_arr, __xlx_sprintf_buffer.data()); 
  }
  tcl_file.set_num(1, &tcl_file.slot_data_arr_depth);
  sprintf(__xlx_sprintf_buffer.data(), "[[/transaction]] \n");
  aesl_fh.write(AUTOTB_TVIN_slot_data_arr, __xlx_sprintf_buffer.data());
}
// print slot_arr_row_len Transactions
{
  ...
  {
    sc_bv<32> __xlx_tmp_lv = *((int*)__xlx_apatb_param_slot_arr_row_len);

    sprintf(__xlx_sprintf_buffer.data(), "%s\n", __xlx_tmp_lv.to_string(SC_HEX).c_str());
    aesl_fh.write(AUTOTB_TVIN_slot_arr_row_len, __xlx_sprintf_buffer.data()); 
  }
  tcl_file.set_num(1, &tcl_file.slot_arr_row_len_depth);
  sprintf(__xlx_sprintf_buffer.data(), "[[/transaction]] \n");
  aesl_fh.write(AUTOTB_TVIN_slot_arr_row_len, __xlx_sprintf_buffer.data());
}
// print output_vec Transactions
{
  ...
  {
    sc_bv<32> __xlx_tmp_lv = *((int*)__xlx_apatb_param_output_vec);

    sprintf(__xlx_sprintf_buffer.data(), "%s\n", __xlx_tmp_lv.to_string(SC_HEX).c_str());
    aesl_fh.write(AUTOTB_TVIN_output_vec, __xlx_sprintf_buffer.data()); 
  }
  tcl_file.set_num(1, &tcl_file.output_vec_depth);
  sprintf(__xlx_sprintf_buffer.data(), "[[/transaction]] \n");
  aesl_fh.write(AUTOTB_TVIN_output_vec, __xlx_sprintf_buffer.data());
}
