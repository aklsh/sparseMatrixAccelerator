...
`define AUTOTB_TVIN_cmd_start  "./c.HLS_CISR_spmv_accel.autotvin_cmd_start.dat"
`define AUTOTB_TVIN_inp_vec  "./c.HLS_CISR_spmv_accel.autotvin_inp_vec.dat"
`define AUTOTB_TVIN_slot_data_arr  "./c.HLS_CISR_spmv_accel.autotvin_slot_data_arr.dat"
`define AUTOTB_TVIN_slot_arr_row_len  "./c.HLS_CISR_spmv_accel.autotvin_slot_arr_row_len.dat"
`define AUTOTB_TVIN_output_vec  "./c.HLS_CISR_spmv_accel.autotvin_output_vec.dat"
`define AUTOTB_TVIN_cmd_start_out_wrapc  "./rtl.HLS_CISR_spmv_accel.autotvin_cmd_start.dat"
`define AUTOTB_TVIN_inp_vec_out_wrapc  "./rtl.HLS_CISR_spmv_accel.autotvin_inp_vec.dat"
`define AUTOTB_TVIN_slot_data_arr_out_wrapc  "./rtl.HLS_CISR_spmv_accel.autotvin_slot_data_arr.dat"
`define AUTOTB_TVIN_slot_arr_row_len_out_wrapc  "./rtl.HLS_CISR_spmv_accel.autotvin_slot_arr_row_len.dat"
`define AUTOTB_TVIN_output_vec_out_wrapc  "./rtl.HLS_CISR_spmv_accel.autotvin_output_vec.dat"
`define AUTOTB_TVOUT_output_vec  "./c.HLS_CISR_spmv_accel.autotvout_output_vec.dat"
`define AUTOTB_TVOUT_output_vec_out_wrapc  "./impl_rtl.HLS_CISR_spmv_accel.autotvout_output_vec.dat"
module `AUTOTB_TOP;
...
parameter LENGTH_slot_data_arr = 2;
parameter LENGTH_slot_arr_row_len = 2;
...
wire [0 : 0] slot_data_arr_address0;
wire  slot_data_arr_ce0;
wire [63 : 0] slot_data_arr_q0;
wire [0 : 0] slot_arr_row_len_address0;
...
wire    [0 : 0]    arrayslot_data_arr_address0, arrayslot_data_arr_address1;
...
wire    [0 : 0]    arrayslot_arr_row_len_address0, arrayslot_arr_row_len_address1;
...
initial begin : generate_AESL_ready_cnt_proc
    ...
    initial begin : finish_simulation
        ...
        @ (posedge AESL_clock);
        @ (posedge AESL_clock);
    fp1 = $fopen("./rtl.HLS_CISR_spmv_accel.autotvout_output_vec.dat", "r");
    fp2 = $fopen("./impl_rtl.HLS_CISR_spmv_accel.autotvout_output_vec.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.HLS_CISR_spmv_accel.autotvout_output_vec.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.HLS_CISR_spmv_accel.autotvout_output_vec.dat\"!");
    else begin
        $display("Comparing rtl.HLS_CISR_spmv_accel.autotvout_output_vec.dat with impl_rtl.HLS_CISR_spmv_accel.autotvout_output_vec.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
