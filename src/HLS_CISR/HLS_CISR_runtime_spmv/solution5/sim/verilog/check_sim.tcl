...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.HLS_CISR_spmv_accel.autotvin_cmd_start.dat"
         "c.HLS_CISR_spmv_accel.autotvin_inp_vec.dat"
         "c.HLS_CISR_spmv_accel.autotvin_slot_data_arr.dat"
         "c.HLS_CISR_spmv_accel.autotvin_slot_arr_row_len.dat"
         "c.HLS_CISR_spmv_accel.autotvin_output_vec.dat"
         "c.HLS_CISR_spmv_accel.autotvout_output_vec.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.HLS_CISR_spmv_accel.autotvout_output_vec.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
