...
module AESL_automem_output_vec (
    clk,
    rst,
    ce0,
    we0,
...
//------------------------Parameter----------------------
localparam
    TV_IN  = "../tv/cdatafile/c.HLS_CISR_spmv_accel.autotvin_output_vec.dat", 
    TV_OUT = "../tv/rtldatafile/rtl.HLS_CISR_spmv_accel.autotvout_output_vec.dat"; 
//------------------------Local signal-------------------
