...
module AESL_automem_slot_data_arr (
    clk,
    rst,
    ce0,
    we0,
...
//------------------------Parameter----------------------
localparam
    TV_IN  = "../tv/cdatafile/c.HLS_CISR_spmv_accel.autotvin_slot_data_arr.dat", 
    TV_OUT = "../tv/rtldatafile/rtl.HLS_CISR_spmv_accel.autotvout_slot_data_arr.dat"; 
//------------------------Local signal-------------------
