...
set id 1
set name HLS_CISR_spmv_accel_fadd_32ns_32ns_32_5_full_dsp_1
...
set id 2
set name HLS_CISR_spmv_accel_fmul_32ns_32ns_32_4_max_dsp_1
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    op interface \
    ports { slot_data_arr_address0 { O 1 vector } slot_data_arr_ce0 { O 1 bit } slot_data_arr_q0 { I 64 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    op interface \
    ports { slot_arr_row_len_address0 { O 1 vector } slot_arr_row_len_ce0 { O 1 bit } slot_arr_row_len_q0 { I 32 vector } } \
} "
} else {
