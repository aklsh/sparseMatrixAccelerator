...
if {[file isfile HLS_CISR_spmv_accel.autotvin.dat]} {
	file delete -force HLS_CISR_spmv_accel.autotvin.dat
}

if {[file isfile HLS_CISR_spmv_accel.autotvout.dat]} {
	file delete -force HLS_CISR_spmv_accel.autotvout.dat
}
