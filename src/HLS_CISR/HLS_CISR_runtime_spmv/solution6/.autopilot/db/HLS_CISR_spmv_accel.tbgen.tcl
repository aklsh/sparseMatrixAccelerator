...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3", "4", "5"],
		...
		"II" : "0",
		"VariableLatency" : "1", "ExactLatency" : "-1", "EstimateLatencyMin" : "25", "EstimateLatencyMax" : "30",
		"Combinational" : "0",
		"Datapath" : "0",
		"ClockEnable" : "0",
		"HasSubDataflow" : "0",
...
set ArgLastReadFirstWriteLatency {
	HLS_CISR_spmv_accel {
		...
		inp_vec {Type I LastRead 12 FirstWrite -1}
		slot_data_arr {Type I LastRead 11 FirstWrite -1}
		slot_arr_row_len {Type I LastRead 5 FirstWrite -1}
		output_vec {Type O LastRead -1 FirstWrite 19}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "25", "Max" : "30"}
	, {"Name" : "Interval", "Min" : "26", "Max" : "31"}
]}
