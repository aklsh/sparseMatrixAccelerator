...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3", "4", "5", "6"],
		...
		"II" : "0",
		"VariableLatency" : "1", "ExactLatency" : "-1", "EstimateLatencyMin" : "29", "EstimateLatencyMax" : "34",
		"Combinational" : "0",
		"Datapath" : "0",
		"ClockEnable" : "0",
		"HasSubDataflow" : "0",
...
set ArgLastReadFirstWriteLatency {
	HLS_CISR_spmv_accel {
		...
		inp_vec {Type I LastRead 10 FirstWrite -1}
		slot_data_arr {Type I LastRead 9 FirstWrite -1}
		slot_arr_row_len {Type I LastRead 3 FirstWrite -1}
		output_vec {Type O LastRead -1 FirstWrite 18}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "29", "Max" : "34"}
	, {"Name" : "Interval", "Min" : "30", "Max" : "35"}
]}
