...
void CISR_decoder(int *slot_row_counter,int row_len_slot_arr[4][2],float *slot_res_arr,int *slot_row_len_id,int *slot_row_id,int* max_row_id)
{
   ...
   for(int slot_id2=0;slot_id2<4;slot_id2++)
            {
# 80 "/home/shivaubuntu/HLS_project/sparseMatrixAccelerator/src/HLS_CISR/HLS_CISR_spmv_accel.c"
...
# 197 "/home/shivaubuntu/HLS_project/sparseMatrixAccelerator/src/HLS_CISR/HLS_CISR_spmv_accel.c"
}
#ifndef HLS_FASTSIM
#ifdef __cplusplus
extern "C"
